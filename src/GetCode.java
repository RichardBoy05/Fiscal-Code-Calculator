...
public class GetCode implements ActionListener {
	 ...
	 * Class: GetCode
	 * Lines: 913
	 * Description: this class contains the method for printing the code in the output field.
	 * 
	 * 
	 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (this.butt.field1.getText().isEmpty()) {
			this.butt.result.setText("___________________");
			JOptionPane.showMessageDialog(null, "Cognome mancante!");
			return;
		}

		if (this.butt.field2.getText().isEmpty()) {
			this.butt.result.setText("___________________");
			JOptionPane.showMessageDialog(null, "Nome mancante!");
			return;
		}

		if (this.butt.field5.getText().isEmpty()) {
			this.butt.result.setText("___________________");
			JOptionPane.showMessageDialog(null, "Anno mancante!");
			return;
		}
		if (this.butt.field5.getText().length() != 4) {
			this.butt.result.setText("___________________");
		...
		String surname = this.butt.field1.getText();
		...
		cons = "";
		for (i = 0; i < lung; i++) {
			sw = Extra.vocals(surname.charAt(i));

			if (sw == 1) {
				sw = 0;
				if (voc.length() < 3)
					voc += surname.charAt(i);
			} else {
		...
		String name = this.butt.field2.getText();
		...
		for (in = 0; in < lungn; in++) {
			swn = Extra.vocals(name.charAt(in));
		...
		String year = this.butt.field5.getText();
		...
		String month = this.butt.field4.getSelectedItem().toString();
		...
		String birthday = this.butt.field3.getSelectedItem().toString();
		...
		String sex = this.butt.field6.getSelectedItem().toString();
		...
		String comune = this.butt.field7.getText();

		String outputcom = "";
		String linea;
		BufferedReader br;
		try {
			br = new BufferedReader(new InputStreamReader(new FileInputStream("Comuni.txt")));
			while (br.hashCode() != -1) {
				linea = br.readLine();
		...
		if (resultot.length() < 15) {
			...
			partot = (par0 * 17) + (par1 * 0) + (par2 * 1) + (par3 * 2) + (par4 * 3) + (par5 * 4) + (par6 * 5)
					+ (par7 * 6) + (par8 * 7) + (par9 * 8) + (par10 * 9) + (par11 * 0) + (par12 * 1) + (par13 * 2)
					+ (par14 * 3) + (par15 * 4) + (par16 * 5) + (par17 * 6) + (par18 * 7) + (par19 * 8) + (par20 * 9)
					+ (par21 * 10) + (par22 * 11) + (par23 * 12) + (par24 * 13) + (par25 * 14) + (par26 * 15)
					+ (par27 * 16) + (par28 * 18) + (par29 * 19) + (par30 * 20) + (par31 * 21) + (par32 * 22)
					+ (par33 * 23) + (par34 * 24) + (par35 * 25);
			...
			dpartot = (dpar0 * 8) + (dpar1 * 1) + (dpar2 * 0) + (dpar3 * 5) + (dpar4 * 7) + (dpar5 * 9) + (dpar6 * 13)
					+ (dpar7 * 15) + (dpar8 * 17) + (dpar9 * 19) + (dpar10 * 21) + (dpar11 * 1) + (dpar12 * 0)
					+ (dpar13 * 5) + (dpar14 * 7) + (dpar15 * 9) + (dpar16 * 13) + (dpar17 * 15) + (dpar18 * 17)
					+ (dpar19 * 19) + (dpar20 * 21) + (dpar21 * 2) + (dpar22 * 4) + (dpar23 * 18) + (dpar24 * 20)
					+ (dpar25 * 11) + (dpar26 * 3) + (dpar27 * 6) + (dpar28 * 12) + (dpar29 * 14) + (dpar30 * 16)
					+ (dpar31 * 10) + (dpar32 * 22) + (dpar33 * 25) + (dpar34 * 24) + (dpar35 * 23);
																											...
																											if (resto == 24) {
																												...
																												if (resto == 25) {
																													...
																													JOptionPane
																															.showMessageDialog(
																																	null,
																																	"Errore di calcolo inaspettato. Riavvia il programma!");
																												}
																											}
																										}
																									}
